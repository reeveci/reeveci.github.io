...
<div style="display: flex; flex-wrap: wrap; gap: .5em; margin: 1.6em 0 -.3em">
  ...
  <a href="https://github.com/reeveci/step-docker-cli/blob/main/LICENSE" target="_blank">
    <img alt="License" src="https://img.shields.io/github/license/reeveci/step-docker-cli?color=%239944ee" />
  </a>
  <a href="https://github.com/reeveci/step-docker-cli" target="_blank">
    <img alt="Git Repository" src="https://img.shields.io/github/stars/reeveci/step-docker-cli?label=Source" />
  </a>
</div>
